      ...
      <div className="w-full max-w-7xl mx-auto relative z-10 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          ...
          <PricingCard
            ...
            price="£0"
            period="/forever"
            description="Try bluebook instantly"
          ...
          <PricingCard
            ...
            features={["bluebook + 7 more", "Complete ecosystem", "Everything included", "Best value for teams", "Priority support", "Coming Q1 2026"]}
...
function PlanModal({
  ...
  const planDetails = {
    free: {
      ...
      features: [
        { icon: "FileSpreadsheet", title: "1 Project", desc: "Perfect for testing bluebook" },
    ...
    bundle: {
      ...
      features: [
        { icon: "MessageSquare", title: "bluebook", desc: "AI insights from Excel files" },
