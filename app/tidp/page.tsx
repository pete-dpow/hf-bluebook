...
export default function TIDPLanding() {
  const [formData, setFormData] = useState({
    name: "",
    email: "",
    company: "",
    role: "",
    appInterest: "dpow.TIDP", // Pre-selected to TIDP
  });
  ...
  // Mouse tracking for gradient (from app/page.tsx)
  useEffect(() => {
  ...
  return (
    ...
    >
      {/* Animated gradient - TIDP pink/red theme */}
      <div
        className="absolute inset-0 pointer-events-none"
        style={{
          background: `radial-gradient(circle at ${mousePos.x}% ${mousePos.y}%, rgba(240, 147, 251, 0.15), transparent 75%)`,
        }}
      />
      ...
      <div className="w-full max-w-2xl relative z-10">
        {!submitSuccess ? (
          <>
            {/* Header - matches app/page.tsx structure */}
            <div className="text-center mb-12">
              ...
              >
                Automated Digital Plan of Work generator
              </p>
              ...
              <div className="mt-6 mb-8 text-center max-w-xl mx-auto">
                ...
                >
                  Parses three key documents—the CSA / pricing schedule, consultant specifications, and client file-naming protocol—to generate a complete, compliant TIDP deliverable schedule.
                </p>
              </div>
            </div>

            {/* Form Card - TWO SECTION STRUCTURE matching app/page.tsx */}
                ...
                <div className="p-6 border-b border-[#E5E7EB]">
                  ...
                  <div className="mb-4">
                    <input
                      ...
                      className="w-full px-4 py-3 text-sm border border-[#E5E7EB] rounded-lg focus:outline-none focus:border-[#f093fb] transition-colors"
            ...
            {/* Help Text - matches app/page.tsx style */}
            <div 
              className="mt-8 text-center space-y-3" 
              style={{ fontFamily: 'var(--font-ibm-plex)' }}
            >
              <p className="text-sm" style={{ color: '#4B4B4B' }}>
                We&apos;ll notify you as soon as dpow.TIDP launches
              </p>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-[#E5E7EB] p-12 text-center">
            <div className="mb-6 flex justify-center">
              <div 
                ...
                style={{ background: 'rgba(79, 165, 154, 0.1)' }}
              >
                <svg 
                  className="w-8 h-8" 
                  fill="none" 
