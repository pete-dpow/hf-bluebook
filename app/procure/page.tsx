...
export default function ProcureLanding() {
  const [formData, setFormData] = useState({
    ...
    company: "",
    role: "",
    appInterest: "dpow.procure", // Pre-selected to procure
  });
  ...
  return (
    ...
    >
      {/* Animated gradient - Procurement cyan/purple theme */}
      <div
        className="absolute inset-0 pointer-events-none"
        style={{
          background: `radial-gradient(circle at ${mousePos.x}% ${mousePos.y}%, rgba(48, 207, 208, 0.15), transparent 75%)`,
        }}
      />
        ...
        {!submitSuccess ? (
          <>
            ...
            <div className="text-center mb-12">
              ...
              >
                Procurement and Material Tracking Intelligence
              </p>
              ...
              <div className="mt-6 mb-8 text-center max-w-xl mx-auto">
                ...
                >
                  Tracks each material&apos;s journey through six stages—Sample Submitted, Sample Approved, Design Sign-Off, Material Ordered, Material Delivered, Installed / Closed. Links TIDP data to live procurement records for transparent progress tracking and automated reporting.
                </p>
              </div>
            </div>
                ...
                <div className="p-6 border-b border-[#E5E7EB]">
                  ...
                  <div className="mb-4">
                    <input
                      ...
                      className="w-full px-4 py-3 text-sm border border-[#E5E7EB] rounded-lg focus:outline-none focus:border-[#30cfd0] transition-colors"
            ...
            >
              <p className="text-sm" style={{ color: '#4B4B4B' }}>
                We&apos;ll notify you as soon as dpow.procure launches
              </p>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-[#E5E7EB] p-12 text-center">
            <div className="mb-6 flex justify-center">
              <div 
                ...
                style={{ background: 'rgba(48, 207, 208, 0.1)' }}
              >
                <svg 
                  className="w-8 h-8" 
                  fill="none" 
