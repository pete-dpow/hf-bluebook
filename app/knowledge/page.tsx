        ...
        <div className="grid grid-cols-3 gap-4 mb-8">
          <div className="bg-white border border-gray-200 rounded-xl p-5">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-sm text-gray-500" style={{ fontFamily: "var(--font-ibm-plex)" }}>Total Chunks</span>
            </div>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-5">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-sm text-gray-500" style={{ fontFamily: "var(--font-ibm-plex)" }}>Source Files</span>
            </div>
            <p className="text-2xl font-medium text-gray-900" style={{ fontFamily: "var(--font-ibm-plex)" }}>
              {totalFiles}
            </p>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-5">
            <div className="flex items-center gap-2 mb-2">
              <BookOpen size={16} className="text-blue-600" />
              <span className="text-sm text-gray-500" style={{ fontFamily: "var(--font-ibm-plex)" }}>Ingestions</span>
            </div>
            <p className="text-2xl font-medium text-gray-900" style={{ fontFamily: "var(--font-ibm-plex)" }}>
              {logs.length}
            </p>
            ...
            <div className="grid grid-cols-3 gap-3">
              {Object.entries(pillarCounts).map(([pillar, count]) => (
                <div key={pillar} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  <span className="text-sm text-gray-700" style={{ fontFamily: "var(--font-ibm-plex)" }}>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-200 bg-gray-50">
                  <th className="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase" style={{ fontFamily: "var(--font-ibm-plex)" }}>File</th>
                  <th className="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase" style={{ fontFamily: "var(--font-ibm-plex)" }}>Status</th>
                  <th className="px-4 py-2 text-right text-xs font-medium text-gray-500 uppercase" style={{ fontFamily: "var(--font-ibm-plex)" }}>Pages</th>
                  <th className="px-4 py-2 text-right text-xs font-medium text-gray-500 uppercase" style={{ fontFamily: "var(--font-ibm-plex)" }}>Chunks</th>
                  <th className="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase" style={{ fontFamily: "var(--font-ibm-plex)" }}>Date</th>
                </tr>
              </thead>
              <tbody>
                {logs.map((log) => (
                  <tr key={log.id} className="border-b border-gray-100">
                    <td className="px-4 py-3 text-sm text-gray-900" style={{ fontFamily: "var(--font-ibm-plex)" }}>
                      {log.source_file}
                      {log.error_message && (
