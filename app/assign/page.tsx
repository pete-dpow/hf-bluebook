...
export default function AssignLanding() {
  const [formData, setFormData] = useState({
    name: "",
    email: "",
    company: "",
    role: "",
    appInterest: "dpow.assign", // Pre-selected to assign
  });
  ...
  return (
    ...
    >
      {/* Animated gradient - Rose team management theme */}
      <div
        className="absolute inset-0 pointer-events-none"
        style={{
          background: `radial-gradient(circle at ${mousePos.x}% ${mousePos.y}%, rgba(244, 63, 94, 0.15), transparent 75%)`,
        }}
      />
        ...
        {!submitSuccess ? (
          <>
            ...
            <div className="text-center mb-12">
              ...
              >
                Workload and Resource Management Intelligence
              </p>
              ...
              <div className="mt-6 mb-8 text-center max-w-xl mx-auto">
                ...
                >
                  Manages staff allocation and workload based on deliverable data from the TIDP. Generates live Gantt views, capacity dashboards, and automated weekly work due reports. Detects overloads and allows conversational rescheduling via dpow.chat.
                </p>
              </div>
            </div>
                ...
                <div className="p-6 border-b border-[#E5E7EB]">
                  ...
                  <div className="mb-4">
                    <input
                      ...
                      className="w-full px-4 py-3 text-sm border border-[#E5E7EB] rounded-lg focus:outline-none focus:border-[#F43F5E] transition-colors"
            ...
            >
              <p className="text-sm" style={{ color: '#4B4B4B' }}>
                We&apos;ll notify you as soon as dpow.assign launches
              </p>
