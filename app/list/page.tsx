...
export default function ListLanding() {
  const [formData, setFormData] = useState({
    ...
    company: "",
    role: "",
    appInterest: "dpow.list", // Pre-selected to list
  });
  ...
  return (
    ...
    >
      {/* Animated gradient - list pink-to-yellow theme */}
      <div
        className="absolute inset-0 pointer-events-none"
        style={{
          background: `radial-gradient(circle at ${mousePos.x}% ${mousePos.y}%, rgba(250, 112, 154, 0.15), transparent 75%)`,
        }}
      />
          ...
          <>
            ...
            <div className="text-center mb-12">
              ...
              <div className="mt-6 mb-8 text-center max-w-xl mx-auto">
                ...
                >
                  Listens to Outlook emails and WhatsApp messages, extracts action requests, and logs them into a structured Excel / SharePoint table with live web-app views. Includes Excel-style filters and Kanban / calendar interfaces.
                </p>
              </div>
            </div>
                ...
                <div className="p-6 border-b border-[#E5E7EB]">
                  ...
                  <div className="mb-4">
                    <input
                      ...
                      className="w-full px-4 py-3 text-sm border border-[#E5E7EB] rounded-lg focus:outline-none focus:border-[#fa709a] transition-colors"
            ...
            >
              <p className="text-sm" style={{ color: '#4B4B4B' }}>
                We&apos;ll notify you as soon as dpow.list launches
              </p>
