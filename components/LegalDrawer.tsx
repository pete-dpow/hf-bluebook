    ...
    <div style={{ maxWidth: "800px", margin: "0 auto" }}>
      ...
      <section id="privacy" data-section="privacy" style={{ marginBottom: "4rem" }}>
        ...
        <p style={{ lineHeight: 1.7, color: "#374151", margin: "0 0 1rem 0" }}>
          bluebook is operated by <strong>DPOW Ltd</strong>, a company registered in England and Wales. 
      ...
      <section id="terms" data-section="terms" style={{ marginBottom: "4rem" }}>
        ...
        <p style={{ lineHeight: 1.7, color: "#374151", margin: "0 0 1rem 0" }}>
          By accessing or using bluebook, you agree to be bound by these Terms of Service. 
        ...
        <p style={{ lineHeight: 1.7, color: "#374151", margin: "0 0 1rem 0" }}>
          bluebook is an AI-powered assistant for construction and project management professionals. 
        ...
        <p style={{ lineHeight: 1.7, color: "#374151", margin: "0 0 1rem 0" }}>
          You retain ownership of all data and content you upload to bluebook. 
        ...
        <p style={{ lineHeight: 1.7, color: "#374151", margin: "0 0 1rem 0" }}>
          bluebook uses artificial intelligence to generate responses. While we strive for accuracy, 
        ...
        {showCookieBanner && !cookieConsent && (
          <div style={{
            ...
            <p style={{ lineHeight: 1.6, color: "#78350F", margin: "0 0 16px 0" }}>
              We use essential cookies to make bluebook work. We'd also like to set optional cookies 
        ...
        <div style={{
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            <div>
              ...
              <p style={{ margin: 0, fontSize: "13px", color: "#6B7280" }}>
                Help us understand how you use bluebook to improve the service
              </p>
            </div>
      ...
      <section id="gdpr" data-section="gdpr" style={{ marginBottom: "4rem" }}>
        ...
        <p style={{ lineHeight: 1.7, color: "#374151", margin: "0 0 1rem 0" }}>
          When you use bluebook, your data is processed as follows:
        </p>
