...
export default function ProfileDrawer() {
  ...
  async function handleClearMemory() {
    if (!confirm('Clear all saved preferences and context?\n\nThis will reset bluebook\'s memory of your preferences. This action cannot be undone.')) {
      return;
    }
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                    ...
                    >
                      ...
                      <p style={{ fontSize: "13px", color: "#6B7280", margin: "0 0 16px 0", lineHeight: "1.5" }}>
                        Import files from OneDrive and SharePoint to analyze in bluebook
                      </p>
                      {microsoftConnected ? (
                        <button
                    ...
                    >
                      ...
                      <div style={{
                        ...
                        <div style={{ fontSize: "12px", color: "#1E40AF", lineHeight: "1.6" }}>
                          <strong>How it works:</strong> Team members can WhatsApp bluebook using their approved number. 
              ...
              <div style={{ marginBottom: "24px" }}>
                ...
                {showMemorySettings && (
                  ...
                  >
                    ...
                    <div style={{ marginBottom: "20px" }}>
                      <p style={{ fontSize: "14px", color: "#6B7280", margin: "0 0 16px 0", lineHeight: "1.6" }}>
                        bluebook remembers your preferences and commonly used terms to provide better responses. 
